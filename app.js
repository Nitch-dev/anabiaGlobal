// Active Core State
const jobDb = [
    { id: 1, title: 'Ammonia Refrigeration Specialist', country: 'Saudi Arabia', type: 'Full-Time', site: 'On Site', desc: 'Maintain complex commercial refrigeration systems. Min 5 years exp.' },
    { id: 2, title: 'Power Plant Commissioning Engineer', country: 'Saudi Arabia', type: 'Full-Time', site: 'On Site', desc: 'Support site layouts and electrical wiring arrays. Trade certified.' },
    { id: 3, title: 'Logistics Fleet Driver', country: 'Saudi Arabia', type: 'Full-Time', site: 'On Site', desc: 'Urgently required for logistics fleet. Valid license essential.' },
    { id: 4, title: 'Civil Waterproofing Supervisor', country: 'Kuwait', type: 'Full-Time', site: 'On Site', desc: 'Supervise infrastructure sealant projects. 3 years Gulf experience.' },
    { id: 5, title: 'Clinical Psychology Consultant', country: 'Maldives', type: 'Full-Time', site: 'On Site', desc: 'Specialist practitioner role for clinical physical recovery division.' }
];
